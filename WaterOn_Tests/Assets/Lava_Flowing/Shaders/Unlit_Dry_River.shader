	...
	SubShader {
		Pass {
			...
			fixed4 frag (v2f i) : Color
			{
				...
				//full river
				//tex = tex*tex.a+tex2*(1-tex.a);//+tex3*(1-tex.a);
				//drying river
				//tex = tex*tex.a+0.5*tex3*(1-tex.a);

				//half dry river
				tex = tex*tex.a+tex3*(1-tex.a);

				//full dry river is without tex2
				//tex = tex*tex.a+tex2*(tex2.a);
